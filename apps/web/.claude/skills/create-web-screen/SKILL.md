...
2. **A rota já existe na API?** `/v1/admin`, `/v1/affiliate/auth` e `GET /v1/affiliate/me` existem. Só a carteira (`/v1/affiliate/me/wallet`) ainda é dublada, em `src/shared/http/mocks/mock-api.ts`, com teste em `mock-api.spec.ts`.
