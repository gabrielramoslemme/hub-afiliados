...
import { type CampaignParams, campaignsHref, PAGE_SIZE } from '../lib/campaign-params';

export function CampaignsPagination({ params, total }: { params: CampaignParams; total: number }) {
    ...
    <div className="flex items-center justify-between border-t border-ink-200 px-4 py-3">
      ...
      <div className="flex items-center gap-2">
        {/*
          ...
          num `span` só para manter o `asChild` quebra o layout do botão.
        */}
        {params.page > 1 ? (
          <Button asChild variant="outline" size="sm">
            <Link href={campaignsHref(params, { page: params.page - 1 })}>
