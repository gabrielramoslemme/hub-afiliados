...
import { fetchAccount, fetchWallet } from '@/features/affiliate-area/queries';
import { StatementList } from '@/features/affiliate-area/statement-list';
import { WalletCard } from '@/features/affiliate-area/wallet-card';
