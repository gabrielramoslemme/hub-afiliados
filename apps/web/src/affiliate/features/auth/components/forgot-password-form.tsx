 ...
 * impede esta tela de virar uma forma de descobrir quem é afiliado. Por isso
 * ela fala no condicional: "se houver uma conta".
 */
export function ForgotPasswordForm() {
  ...
  if (sent) {
    return (
      <div className="flex flex-col gap-5">
        <div className="animate-alert flex items-start gap-3 rounded-md border border-ink-200 bg-blue-50 px-4 py-3.5">
          <MailCheck className="mt-0.5 size-4 shrink-0 text-blue-600" aria-hidden />
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} noValidate className="flex flex-col gap-5">
      ...
      <Field id="email" label="E-mail do cadastro" required error={errors.email?.message}>
        <Input
          {...register('email')}
